...
public class ItemsInit {
    ...
    public static final RegistryObject<NewShieldItem> WOODEN_SHIELD = registerShield("wooden_shield", 55, 0.9F, 0.0F);
    public static final RegistryObject<NewShieldItem> GOLDEN_SHIELD = registerShield("golden_shield", 77, 0.78F, 0.15F);
    public static final RegistryObject<NewShieldItem> IRON_SHIELD = registerShield("iron_shield", 165, 0.64F, 0.30F);
    public static final RegistryObject<NewShieldItem> DIAMOND_SHIELD = registerShield("diamond_shield", 363, 0.55F, 0.50F);
    public static final RegistryObject<NewShieldItem> NETHERITE_SHIELD = registerShield("netherite_shield", 607, 0.38F, 0.75F);
