...
public class ItemsInit {
    ...
    public static final RegistryObject<NewShieldItem> WOODEN_SHIELD = registerShield("wooden_shield", 55, 10, 0.78F, 0.0F, 8);
    public static final RegistryObject<NewShieldItem> GOLDEN_SHIELD = registerShield("golden_shield", 77, 10, 0.9F, 0.0F, 8);
    public static final RegistryObject<NewShieldItem> IRON_SHIELD = registerShield("iron_shield", 165, 20, 0.64F, 0.20F, 5);
    public static final RegistryObject<NewShieldItem> DIAMOND_SHIELD = registerShield("diamond_shield", 363, 40, 0.55F, 0.35F, 4);
